...
public class Image_upload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.image_upload_test);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == RESULT_LOAD_IMG && resultCode == RESULT_OK
                ...
                Toast.makeText(this,"length: ->"+ String.valueOf(fileNameSegments.length )+"\nindex:0 ->"+ fileNameSegments[0]  +"\n"+"index:1 ->"+ fileNameSegments[1]  +"\n"+"index:2 ->"+ fileNameSegments[2]  +"\n"+"index:3 ->"+ fileNameSegments[3]  +"\n"+"index:4 ->"+ fileNameSegments[4]  +"\n"+"index:5 ->"+ fileNameSegments[5]+"\n",
    ...
    public void makeHTTPCall() {
        ...
        client.post("http://192.168.14.38:8805/finalproject/File_Test.do",
