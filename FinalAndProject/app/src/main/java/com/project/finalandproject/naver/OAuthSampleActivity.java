package com.project.finalandproject.naver;
...
public class OAuthSampleActivity extends Activity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "YvqElEzARe1B1zcoMktx";
    private static String OAUTH_CLIENT_SECRET = "Trp4XEcdr4";
