package com.project.finalandproject.openapi.sampleapp.demos;
...
import com.project.finalandproject.openapi.sampleapp.MapApiConst;
import com.project.finalandproject.openapi.search.Item;
import com.project.finalandproject.openapi.search.OnFinishSearchListener;
import com.project.finalandproject.openapi.search.Searcher;
...
public class SearchRoute extends FragmentActivity implements MapView.MapViewEventListener, MapView.POIItemEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_search2);
        ...
        mButtonSearch.setOnClickListener(new OnClickListener() { // 검색버튼 클릭 이벤트 리스너
			...
			public void onClick(View v) {
		        ...
		        Searcher searcher = new Searcher(); // net.daum.android.map.openapi.openapi.search.Searcher
    ...
    private void showToast(final String text) {
		runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(SearchRoute.this, text, Toast.LENGTH_SHORT).show();
			}
		});
    }
	...
	public void onCalloutBalloonOfPOIItemTouched(MapView mapView, MapPOIItem mapPOIItem, MapPOIItem.CalloutBalloonButtonType calloutBalloonButtonType) {
		...
		ad.setTitle("장소설정");
		ad.setMessage(item.title+"를 선택하시겠습니까?");
